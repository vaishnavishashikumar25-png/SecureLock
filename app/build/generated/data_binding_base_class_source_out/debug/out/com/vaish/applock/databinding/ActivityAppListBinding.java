...
public final class ActivityAppListBinding implements ViewBinding {
  ...
  private ActivityAppListBinding(@NonNull CoordinatorLayout rootView, @NonNull RecyclerView rvApps,
  ...
  public static ActivityAppListBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityAppListBinding((CoordinatorLayout) rootView, rvApps, toolbar);
    }
